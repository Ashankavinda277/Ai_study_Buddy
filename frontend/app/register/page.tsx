        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="name" className="text-xs font-semibold text-indigo-950">
                Name
              </label>
              <div className="relative">
                <User className="pointer-events-none absolute top-1/2 left-4 h-4 w-4 -translate-y-1/2 text-indigo-300" />
                <input
                  id="name"
                  required
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-indigo-300">At least 8 characters.</p>
            </div>
